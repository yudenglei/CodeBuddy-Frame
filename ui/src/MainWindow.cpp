...
void MainWindow::setupMenuBar() {
    ...
    ActionManager::instance().onActionRegistered(
        [this](const ActionDescriptor& desc) { menuBuilder_->insertAction(desc); }
    );
}
...
void MainWindow::setupCentralWidget() {
    ...
    label->setStyleSheet("background:#1e1e2e; color:#cdd6f4; font-size:18px; border:1px solid #45475a;");
...
MenuBuilder* MainWindow::getMenuBuilder() const { return menuBuilder_.get(); }
